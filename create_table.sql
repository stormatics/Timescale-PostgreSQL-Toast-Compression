drop table if exists  hit_uncompressed;
...
drop table if exists  hit_compressed_lz4;
...
drop table if exists hit_compressed_pglz;
...
drop table if exists hit_hyper_compressed;
